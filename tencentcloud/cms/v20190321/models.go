...
type TextData struct {
	DetailResult []struct {
		EvilType     int32    `json:"EvilType,omitempty" name:"EvilType"`
		KeywordsList []string `json:"KeywordsList,omitempty" name:"KeywordsList"`
	} `json:"DetailResult,omitempty" name:"DetailResult"`
	// 是否恶意 0：正常 1：可疑
	EvilFlag *int64 `json:"EvilFlag,omitempty" name:"EvilFlag"`
